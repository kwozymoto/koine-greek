...
data/gnt/, and this runs the lot:
    ...
    check_icons      that every drill has an icon chosen for it rather than
                     falling back to the generic one, that every icon named
                     is drawn, and that every group has a colour
    ...
    check_render     every English rendering in a lesson, against six public
                     domain translations: a word none of them uses is either
                     a decision to record or a mistake
...
CHECKS = ["check_greek_norm", "check_mark", "check_keys", "check_icons",
          "check_vocab",
          "check_drills",
          "check_paradigms",
          "check_grids",
          "check_readings", "check_gloss", "check_render", "check_lessons",
          "check_quiz", "check_options", "check_distractors", "check_xref",
          "check_forms",
