...
/* Vocabulary pronunciation — one clip per lemma, indexed by position in
   ...
   Entries 470-510 — the words appended for Black's chapter lists — were
   recorded separately at 22kHz rather than 44.1kHz; same voice, same 64kbps
   mono, and indistinguishable in use. Callers still treat a missing entry as
   "no audio" (no "Hear it" button, unlit lookup speaker), which is what
   keeps the two arrays safe to drift apart again.
