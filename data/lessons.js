...
<p>"Just as he chose us in him before the foundation of the world." <span class="gk">ἐξελέξατο</span> is unmistakably a middle, and the aorist is where you can see that. What the voice <i>adds</i> is a harder question, and chapter 12 gave you the one to ask first: <span class="gk">ἐκλέγομαι</span> has no active anywhere in the New Testament. Of its twenty-two occurrences, twenty-one are middle and one is passive — there was nothing to choose against. "God chose for himself" is a possible reading; it is not one the form establishes.</p>
...
<p><span class="gk">πίστις, πίστεως</span>, "faith" (242 occurrences) · <span class="gk">πόλις, πόλεως</span>, "city" (163) · <span class="gk">δύναμις, δυνάμεως</span>, "power" (119).</p>
...
<p>Of <span class="gk">δίδωμι</span>'s 415 occurrences, the commonest single forms are <span class="gk">ἔδωκεν</span> (64), <span class="gk">δοῦναι</span> (33) and <span class="gk">ἐδόθη</span> (31) — an aorist indicative, an aorist infinitive and an aorist passive. The whole present active indicative, all four attested forms of it, comes to 21.</p>
...
<p><span class="gk">ἵστημι</span>, "I set, stand" (153), is the difficult one, and not because of its forms. <b>Tense and voice together decide whether it takes an object.</b> The first aorist active <span class="gk">ἔστησεν</span> is transitive — he set something up. Nothing else you are likely to meet is: the second aorist <span class="gk">ἔστη</span>, the twenty aorist passives like <span class="gk">σταθείς</span>, and the perfect <span class="gk">ἕστηκα</span>, which alone accounts for 65 of the 153.</p>
