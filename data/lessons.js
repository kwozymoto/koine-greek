...
{q:"You meet ἐν. Without reading another word, what case follows it?",o:["Genitive","Dative","Accusative","Any of the three"],a:1,w:"Always the dative. ἐν, εἰς, ἐκ and ἀπό each take one case only, which makes them the most reliable case signals in the text — ἐν dative, εἰς accusative, ἐκ and ἀπό genitive."}]},
...
<p>The commonest are irregular and worth knowing on sight: <span class="gk">ἀγαθός → κρείσσων</span> (better), <span class="gk">κακός → χείρων</span> (worse), <span class="gk">μέγας → μείζων</span> (greater), <span class="gk">πολύς → πλείων</span> (more).</p>
<p>Two cautions for reading. The thing compared against stands either in the genitive — <span class="gk">μείζων τούτων</span>, "greater than these" — or after <span class="gk">ἤ</span>, "than". And in Koine the superlative is fading: a comparative form often does superlative work, so <span class="gk">μείζων</span> can mean "greatest" as readily as "greater". The context decides that, not the ending.</p>
