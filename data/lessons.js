...
{q:"The tax collector says τῷ ἁμαρτωλῷ, with the article. What does that do?",o:["Identifies him as the sinner, not a sinner","Nothing; Greek always uses it","Makes it plural","Marks the dative only"],a:0,w:"The article points at particular identity. He does not say a sinner, and most English translations lose the distinction.",sec:7},
...
{q:"In ἄγγελοι προσῆλθον καὶ διηκόνουν αὐτῷ, why do translations often render the second verb 'were ministering'?",o:["It is plural","It is passive","It is imperfect, so the action is presented as open","It is a different tense entirely"],a:2,w:"προσῆλθον is aorist — one event, closed. διηκόνουν is imperfect, and the ministering does not close. The switch between them is doing something.",sec:3},
